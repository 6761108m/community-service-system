...
if ($isDisabled === 'disabled') {
    echo "<script>alert('You cannot unjoin this event as the event date has already passed.'); window.location.href='supreme_feed.php';</script>";
    exit();
}
...
if ($stmt->execute()) {
    ...
    echo "<script>alert('You have successfully unjoined the event!'); window.location.href='supreme_feed.php';</script>";
} else {
    // Error
