...
<header>
    ...
    <nav>
        <ul>
            ...
            <li class="active"><a href="supreme_feed.php">Feed</a></li>
...
<a href="supreme_create_post.html" class="btn">Create New Post</a>
<br><br>
       ...
       ?>
        ...
        <div class="post">
            ...
            <?php if ($_SESSION['username'] == $row['Username']) { ?>
                <form action="supreme_edit_post.php" method="GET" style="display: inline;">
                    <input type="hidden" name="post_id" value="<?= $row['PostID']; ?>">
                    <button type="submit">Edit</button>
                </form>

                <form action="supreme_delete_post.php" method="POST" style="display: inline;">
                    <input type="hidden" name="post_id" value="<?= $row['PostID']; ?>">
